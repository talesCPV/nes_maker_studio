...
if (!is_array($nms)) {
    ...
    response([
        'success' => false,
        'message' =>
            'O conteúdo AGC não foi enviado corretamente.'
    ], 422);
}
...
try {
     ...
     * -----------------------------------------------------
     *
     * O banco e o arquivo AGC precisam permanecer
     * sincronizados.
     */
    ...
    if ($nmsContents === false) {
        ...
        response([
            'success' => false,
            'message' =>
                'Não foi possível serializar o projeto AGC.'
        ], 500);
    }
    ...
    if ($filename === '') {
        ...
        response([
            'success' => false,
            'message' =>
                'O projeto não possui arquivo AGC.'
        ], 500);
    }
     ...
     * Depois substituímos o AGC original.
     *
    ...
    if (
        ...
        response([
            'success' => false,
            'message' =>
                'Não foi possível salvar o arquivo AGC.'
        ], 500);
    }

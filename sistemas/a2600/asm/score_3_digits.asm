...
; --- Score band left delay=4 digits=3 ---
DrawScoreBand:
    lda #0
    sta PF0
    sta PF1
    ...
    sta VDELP0
    sta VDELP1
    lda #1                  ; P0: 2 cópias close (0 e +16)
    sta NUSIZ0
    lda #0
    sta NUSIZ1
    lda #$0E
...
ScDigRows:
    ...
    adc TmpA
    tax
    lda ScStrip,x           ; centena → 1ª cópia P0
    sta GRP0
    inx
    lda ScStrip,x           ; dezena → P1
    sta GRP1
    inx
    lda ScStrip,x           ; unidade → 2ª cópia P0
    sta GRP0
    iny
    cpy #6
    bcc ScDigRows

...
const BUILD = (() => {
  ...
  const NGC_ENDPOINT = (typeof APP==="function"?APP("/sistemas/nes/backend/build.php"):"/sistemas/nes/backend/build.php");
  const CFG_ENDPOINT = (typeof APP==="function"?APP("/sistemas/nes/backend/cfg.php"):"/sistemas/nes/backend/cfg.php");
  const ASSEMBLE_ENDPOINT = (typeof APP==="function"?APP("/sistemas/nes/backend/assemble.php"):"/sistemas/nes/backend/assemble.php");

// Biblioteca pessoal do usuário (.nsound / .tile) — /nes/backend/library/*
const AssetLibrary = (() => {
  const BASE = (typeof APP==='function'?APP('/sistemas/nes/backend/library'):'/sistemas/nes/backend/library');

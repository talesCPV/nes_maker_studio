...
const CHAR = (() => {
  ...
  return {init,loadData,render,addCharacter,duplicate,deleteCharacter,selectCharacter,selectAnim,selectFrame,addAnim,removeAnim,addFrame,removeFrame,moveFrame,useMetatile,setFrameDuration,setField,togglePlay,prevFrame,nextFrame};
})();

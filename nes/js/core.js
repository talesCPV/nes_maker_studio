...
const Project = {
  ...
  async createProjectOnBackend(name, description, parentProjectId){
    ...
    const response = await fetch(APP('/nes/backend/projects/create.php'), {
      method: 'POST',
  ...
  async uploadThumbnailIfMissing(dataUrl){
    ...
    try {
      const response = await fetch(APP('/nes/backend/projects/thumbnail.php'), {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        credentials: 'same-origin',
        body: JSON.stringify({
  ...
  async saveProjectToBackend(projectId, nms){
    const response = await fetch(APP('/nes/backend/projects/save.php'), {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      credentials: 'same-origin',
      body: JSON.stringify({
  ...
  async loadProjectFromBackend(projectId) {
    ...
    try {
      ...
      const response =
        await fetch(
          APP(`/nes/backend/projects/load.php?id=${encodeURIComponent(projectId)}`),
          {
            method: 'GET',
            credentials: 'same-origin'
          }
